...
object Config {
    ...
    const val KI = 0.1f
    const val KD = 0.3f
    const val SAFE_DISTANCE_MIN = 5.0
    const val SAFE_DISTANCE_MAX = 30.0
    const val TARGET_DISTANCE = 15.0
    ...
    const val MQTT_BROKER = "192.168.56.20"
    ...
    const val SENSOR_RANGE_M = 10.0
    const val SAFETY_MARGIN_M = 2.0
}
